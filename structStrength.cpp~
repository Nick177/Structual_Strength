...
int main()
{
	...
	fout << "Mean of coupon values for Steel: " << setw(25) << avg1 << endl;
	fout << "Mean of coupon values for Graphite: " << setw(22) << avg2 << endl;
	fout << "Max value of coupon values for Steel: " << setw(18) << maxVal(v1) << endl;
	fout << "Max value of coupon values for Graphite: " << setw(15) << maxVal(v2) << endl;
	fout << "Min value of coupon values for Steel: " << setw(18) << minVal(v1) << endl;
	fout << "Min value coupon values for Graphite: " << setw(18) << minVal(v2) << endl;
	fout << "Variance for Steel coupon values: " << setw(25) << var1 << endl;
	fout << "Variance for Graphite coupon values: " << setw(19) << var2 << endl;
